...
export default function AIServicesPage() {
  ...
  return (
    <ThemeProvider attribute="class" defaultTheme="light">
      <MetaTags
        title="Enterprise AI & Automation Services | NathCorp"
        description="Transform your AI vision into reality with NathCorp. Expertise in Agentic AI, RAG architecture, and custom LLM integration."
        keywords="Enterprise AI, Machine Learning, Agentic AI, RAG, LLM Integration, Computer Vision"
