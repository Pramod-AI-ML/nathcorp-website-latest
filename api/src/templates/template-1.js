 ...
 * Recipient:    Internal team / support inbox
 *
 * Contains the full submission so the team can action the enquiry.
 *
 * @param {object} data
...
function templateInternalNotification({ name, email, phone = "", company = "", service = "", office = "", subject = "", message = "" }) {
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr>
          <td style="padding-top:32px;padding-bottom:32px;
            ...
            <p style="margin-top:0;margin-bottom:0;font-family:Arial,sans-serif;
              ...
              Please respond to the customer within 1 business day.
            </p>
        ...
        <tr>
          <td bgcolor="#f9fafb"
            ...
            &copy; ${year} Your Company Name &mdash; Internal Use Only
          </td>
        </tr>
  ...
  const plainText = [
    ...
    `Please respond to the customer within 1 business day.`,
    ``,
    `© ${year} Your Company Name — Internal Use Only`,
  ]
    .filter((l) => l !== null)
    .join("\n");

  return {
    subject: `[New Enquiry] ${name} — ${subject || "Contact Form"}`,
    html,
    plainText,
  };
}

module.exports = { templateInternalNotification };